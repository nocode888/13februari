...
export const AnalyticsAI: React.FC<AnalyticsAIProps> = ({ insights, onInsightGenerated }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Add analytics context to the prompt
...
Please analyze this data and provide insights based on the question.`;
      ...
      const response = await OpenAIService.generateResponse(analyticsContext);
      ...
      <div className={`h-full flex flex-col transition-opacity duration-300 ${
        ...
        <div className="border-b border-gray-200 p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-lg font-medium text-gray-900">Analytics AI</h2>
          </div>
          ...
          <div className="flex gap-2">
            <div className="flex-1 relative">
              <input
                ...
                placeholder={replyingTo !== null ? "Type your reply..." : "Ask about analytics..."}
